...
export default function Cards_Products({ item,setCart }) {
  ...
  return (
    <View className="bg-amber-400 h-28 justify-center rounded-2xl px-4 shadow-xl">
        ...
        <View className="flex-1 flex-row items-center justify-center">
          <View className="flex-1 items-center">
            <TouchableOpacity
              ...
              className="bg-red-500 w-8 h-8 items-center rounded-full" //justify-center
            >
          ...
          <View className="flex-1 items-center">
            <TouchableOpacity
              onPress={() => ChangueQuantity(item, 1)}
              className="bg-green-500 w-8 h-8 items-center rounded-full" //justify-center
            >
              <Text className="font-bold text-xl text-white">+</Text>
            </TouchableOpacity>
          </View>
